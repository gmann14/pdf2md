...
Accessible version: [https://www.cdc.gov/nndss/about/index.html](https://www.cdc.gov/nndss/about/index.html)

### NNDSS BY THE NUMBERS
...
## 120 • infectious diseases • bioterrorism agents reported through NNDSS each year • sexually transmitted diseases • noninfectious conditions

About 3,000 public health departments 100% of the American population

## 3K send disease data to 60 state, territorial, and 100% protected other public health departments, who then send the data to CDC

### WHY WE DO NOTIFIABLE DISEASE SURVEILLANCE

| Detect Disease | Stop Disease      | Study Disease | Improve How | Keep People |
| -------------- | ----------------- | ------------- | ----------- | ----------- |
| When and       | Before It Spreads | to Strengthen | We Prevent  | Healthy     |
